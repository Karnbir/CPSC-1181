    ...
    public static void main(String[] args) {
        ...
        System.out.println("Information recorded on the college was: \n" + langaraCollege);
            ...
            public static boolean verifyName (String str)
            {
                ...
                str = str.trim();
                if (str.indexOf(" ") == -1) {
                    System.out.println("You must enter two words: first and last name with space in the middle");
                    return false;
                }
                str = str.substring(str.indexOf(" ") + 1);
                if (str.indexOf(" ") != -1) {
                    System.out.println("You must enter one name and one last name with space in the middle");
                    return false;
                }
                return true;
            }
