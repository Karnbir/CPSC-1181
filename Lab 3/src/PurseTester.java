...
public class PurseTester
{
	   ...
	   */
	   public static void main(String[] args)
	   {
			  ...
			  g.addCoin(quarter);
			  g.removeCoin(quarter);
			  System.out.println("Remove coin test: Expected: 0 , Actual: " + g.count(quarter));

			  //extra count coin test
			  System.out.println("Count coin test: Expected: 2, Actual: " + d.count(quarter));

		      //getHighestCoinValue empty test
		   Purse h = new Purse ();
		      System.out.println("getMaximum test: Expected: null, Actual: " + h.getMaximum());

		   //getHighestCoinValue test
		   System.out.println("getMaximum test: Expected: (quarter, 25), Actual: " + a.getMaximum());
	   }
